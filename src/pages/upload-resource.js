...
import C from '../../src/pages_/upload-resource'
...
import ns10 from '../../locales/en/upload-resource.json'

const namespaces = { 'common': ns0, '_error': ns1, '404': ns2, 'languages': ns3, 'forms': ns4, 'validation': ns5, 'notifications': ns6, 'tooltips': ns7, 'activity': ns8, 'offline': ns9, 'upload-resource': ns10 }
