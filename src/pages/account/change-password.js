...
import C from '../../../src/pages_/account/change-password'
...
import ns10 from '../../../locales/en/change-password.json'

const namespaces = { 'common': ns0, '_error': ns1, '404': ns2, 'languages': ns3, 'forms': ns4, 'validation': ns5, 'notifications': ns6, 'tooltips': ns7, 'activity': ns8, 'offline': ns9, 'change-password': ns10 }
