...
import C, * as _rest from '../../../../src/pages_/courses/[id]'
...
import ns10 from '../../../../locales/fi/course.json'

const namespaces = { 'common': ns0, '_error': ns1, '404': ns2, 'languages': ns3, 'forms': ns4, 'validation': ns5, 'notifications': ns6, 'tooltips': ns7, 'activity': ns8, 'offline': ns9, 'course': ns10 }
