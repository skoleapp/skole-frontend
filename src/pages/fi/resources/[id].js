...
import C, * as _rest from '../../../../src/pages_/resources/[id]'
...
import ns10 from '../../../../locales/fi/resource.json'

const namespaces = { 'common': ns0, '_error': ns1, '404': ns2, 'languages': ns3, 'forms': ns4, 'validation': ns5, 'notifications': ns6, 'tooltips': ns7, 'activity': ns8, 'offline': ns9, 'resource': ns10 }
...
export const getStaticProps = ctx => _rest.getStaticProps({ ...ctx, lang: 'fi' })
export const getStaticPaths = ctx => _rest.getStaticPaths({ ...ctx, lang: 'fi' })
