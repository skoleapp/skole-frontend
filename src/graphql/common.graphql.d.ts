...
export declare type TrendingCommentsQueryVariables = Exact<{
    [key: string]: never;
}>;
export declare type TrendingCommentsQuery = ({
    __typename?: 'Query';
} & {
...
export declare const TrendingCommentsDocument: Apollo.DocumentNode;
/**
 ...
 * });
 */
export declare function useTrendingCommentsQuery(baseOptions?: Apollo.QueryHookOptions<TrendingCommentsQuery, TrendingCommentsQueryVariables>): Apollo.QueryResult<TrendingCommentsQuery, Exact<{
    [key: string]: never;
}>>;
export declare function useTrendingCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TrendingCommentsQuery, TrendingCommentsQueryVariables>): Apollo.QueryTuple<TrendingCommentsQuery, Exact<{
    [key: string]: never;
}>>;
export declare type TrendingCommentsQueryHookResult = ReturnType<typeof useTrendingCommentsQuery>;
export declare type TrendingCommentsLazyQueryHookResult = ReturnType<typeof useTrendingCommentsLazyQuery>;
export declare type TrendingCommentsQueryResult = Apollo.QueryResult<TrendingCommentsQuery, TrendingCommentsQueryVariables>;
