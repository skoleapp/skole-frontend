/* 69e18c758f1d773e966c1bfdce0c1c43a3b4018b
...
export declare type Mutation = {
     ...
     * The `user` field must match with the ID of the user making the query to save the user making the query as the author of the comment.
     * This way even authenticated users can create anonymous comments by setting the ´user´ field as `null`.
     */
...
export declare type MutationResendVerificationEmailArgs = {
 ...
 * - The user has already verified one's account.
 */
export declare type ResendVerificationEmailMutationPayload = {
...
export declare type ResendVerificationEmailMutationInput = {
    email: Scalars['String'];
    clientMutationId?: Maybe<Scalars['String']>;
};
/**
...
export declare type ResendVerificationEmailMutationVariables = Exact<{
    email: Scalars['String'];
}>;
...
export declare function useCreateCourseMutation(baseOptions?: Apollo.MutationHookOptions<CreateCourseMutation, CreateCourseMutationVariables>): Apollo.MutationTuple<CreateCourseMutation, Exact<{
    courseName: string;
    courseCode?: string | null | undefined;
    subjects?: Maybe<string>[] | null | undefined;
    school: string;
}>>;
...
export declare type ResendVerificationEmailMutationFn = Apollo.MutationFunction<ResendVerificationEmailMutation, ResendVerificationEmailMutationVariables>;
/**
 ...
 * });
 */
export declare function useResendVerificationEmailMutation(baseOptions?: Apollo.MutationHookOptions<ResendVerificationEmailMutation, ResendVerificationEmailMutationVariables>): Apollo.MutationTuple<ResendVerificationEmailMutation, Exact<{
    email: string;
}>>;
export declare type ResendVerificationEmailMutationHookResult = ReturnType<typeof useResendVerificationEmailMutation>;
export declare type ResendVerificationEmailMutationResult = Apollo.MutationResult<ResendVerificationEmailMutation>;
export declare type ResendVerificationEmailMutationOptions = Apollo.BaseMutationOptions<ResendVerificationEmailMutation, ResendVerificationEmailMutationVariables>;
