...
export declare type ReferralCodeObjectType = {
...
export declare type MutationUseReferralCodeArgs = {
 ...
 * After successfully entering the referral code, send account verification email.
 */
export declare type UseReferralCodeMutationPayload = {
...
export declare type UseReferralCodeMutationInput = {
    code: Scalars['String'];
    email: Scalars['String'];
    clientMutationId?: Maybe<Scalars['String']>;
};
