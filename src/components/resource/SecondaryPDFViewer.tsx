...
const SecondaryPDFViewer: React.FC<Props> = ({ url = 'https://arxiv.org/pdf/1708.08021.pdf', highlights: initialHighlights = testHighlights }) => {
    const [highlights, setHighlights] = useState<Array<Highlight>>(initialHighlights);
    const { query, pathname } = useRouter();
    const parseIdFromHash = (): string => document.location.hash.slice('#highlight-'.length);
    const resetHash = (): string => (document.location.hash = '');
    ...
    updateHighlight(highlightId: string, position: Record<string, any>, content: Record<string, any>) {
    ...
    render() {
        ...
        return (
            <div className="App" style={{ display: 'flex', height: '100vh' }}>
                <Sidebar highlights={highlights} resetHighlights={this.resetHighlights} />
                <div
                    style={{
                        height: '100vh',
                        width: '75vw',
