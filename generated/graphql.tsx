...
export type RegisterMutation = { __typename?: 'Mutation' } & {
    register: Maybe<
        { __typename?: 'RegisterMutationPayload' } & {
            user: Maybe<{ __typename?: 'UserObjectType' } & Pick<UserObjectType, 'id' | 'created'>>;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
    >;
    login: Maybe<
        { __typename?: 'LoginMutationPayload' } & Pick<LoginMutationPayload, 'token'> & {
                user: Maybe<
                    { __typename?: 'UserObjectType' } & Pick<
                        UserObjectType,
                        'id' | 'title' | 'bio' | 'avatar' | 'points' | 'created' | 'email'
                    >
                >;
                errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
            }
        ...
        { __typename?: 'CreateCommentMutationPayload' } & {
            comment: Maybe<
                { __typename?: 'CommentObjectType' } & Pick<
                    CommentObjectType,
                    'id' | 'text' | 'attachment' | 'modified' | 'created' | 'replyCount' | 'points'
                > & {
                        user: Maybe<
                            { __typename?: 'UserObjectType' } & Pick<
                                UserObjectType,
                        ...
                        replyComments: Array<
                            { __typename?: 'CommentObjectType' } & Pick<
                                CommentObjectType,
                                'id' | 'text' | 'attachment' | 'modified' | 'created' | 'points'
                            > & {
                                    user: Maybe<
                                        { __typename?: 'UserObjectType' } & Pick<
                                            UserObjectType,
                                    ...
                                    >;
                                    vote: Maybe<
                                        { __typename?: 'VoteObjectType' } & Pick<VoteObjectType, 'id' | 'status'>
                                    >;
                                }
                        >;
...
export type DeleteCommentMutation = { __typename?: 'Mutation' } & {
    deleteComment: Maybe<
        { __typename?: 'DeleteCommentMutationPayload' } & Pick<DeleteCommentMutationPayload, 'message'> & {
                errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
            }
    >;
};
...
export type SchoolsQuery = { __typename?: 'Query' } & {
    schools: Maybe<Array<Maybe<{ __typename?: 'SchoolObjectType' } & Pick<SchoolObjectType, 'id' | 'name'>>>>;
};

export type SchoolTypesQueryVariables = {};

export type SchoolTypesQuery = { __typename?: 'Query' } & {
    schoolTypes: Maybe<
        Array<Maybe<{ __typename?: 'SchoolTypeObjectType' } & Pick<SchoolTypeObjectType, 'id' | 'name'>>>
    >;
};
...
export type CoursesQuery = { __typename?: 'Query' } & {
    courses: Maybe<Array<Maybe<{ __typename?: 'CourseObjectType' } & Pick<CourseObjectType, 'id' | 'name'>>>>;
};

export type SubjectsQueryVariables = {};

export type SubjectsQuery = { __typename?: 'Query' } & {
    subjects: Maybe<Array<Maybe<{ __typename?: 'SubjectObjectType' } & Pick<SubjectObjectType, 'id' | 'name'>>>>;
};

export type CountriesQueryVariables = {};

export type CountriesQuery = { __typename?: 'Query' } & {
    countries: Maybe<Array<Maybe<{ __typename?: 'CountryObjectType' } & Pick<CountryObjectType, 'id' | 'name'>>>>;
};

export type CitiesQueryVariables = {};

export type CitiesQuery = { __typename?: 'Query' } & {
    cities: Maybe<Array<Maybe<{ __typename?: 'CityObjectType' } & Pick<CityObjectType, 'id' | 'name'>>>>;
};

export type ResourceTypesQueryVariables = {};

export type ResourceTypesQuery = { __typename?: 'Query' } & {
    resourceTypes: Maybe<
        Array<Maybe<{ __typename?: 'ResourceTypeObjectType' } & Pick<ResourceTypeObjectType, 'id' | 'name'>>>
    >;
};
...
export type ContactMutation = { __typename?: 'Mutation' } & {
    contact: Maybe<
        { __typename?: 'ContactMutationPayload' } & Pick<ContactMutationPayload, 'message'> & {
                errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
            }
    >;
};
...
export type CourseDetailQuery = { __typename?: 'Query' } & {
    course: Maybe<
        { __typename?: 'CourseObjectType' } & Pick<
            CourseObjectType,
            'id' | 'name' | 'code' | 'modified' | 'created' | 'points' | 'resourceCount'
        > & {
                subject: Maybe<{ __typename?: 'SubjectObjectType' } & Pick<SubjectObjectType, 'id' | 'name'>>;
                school: { __typename?: 'SchoolObjectType' } & Pick<SchoolObjectType, 'id' | 'name'>;
                user: Maybe<{ __typename?: 'UserObjectType' } & Pick<UserObjectType, 'id' | 'username'>>;
                resources: Array<
                    { __typename?: 'ResourceObjectType' } & Pick<ResourceObjectType, 'id' | 'title' | 'points'>
                >;
                comments: Array<
                    { __typename?: 'CommentObjectType' } & Pick<
                        CommentObjectType,
...
export type CreateCourseMutation = { __typename?: 'Mutation' } & {
    createCourse: Maybe<
        { __typename?: 'CreateCourseMutationPayload' } & {
            course: Maybe<{ __typename?: 'CourseObjectType' } & Pick<CourseObjectType, 'id'>>;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
    >;
};
...
export type CreateResourceInitialDataQuery = { __typename?: 'Query' } & {
    course: Maybe<{ __typename?: 'CourseObjectType' } & Pick<CourseObjectType, 'id' | 'name'>>;
};
...
export type CreateResourceMutation = { __typename?: 'Mutation' } & {
    createResource: Maybe<
        { __typename?: 'CreateResourceMutationPayload' } & {
            resource: Maybe<{ __typename?: 'ResourceObjectType' } & Pick<ResourceObjectType, 'id'>>;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
    >;
};
...
export type ResourceDetailQuery = { __typename?: 'Query' } & {
    resource: Maybe<
        { __typename?: 'ResourceObjectType' } & Pick<
            ResourceObjectType,
            'id' | 'title' | 'resourceType' | 'file' | 'date' | 'modified' | 'created' | 'points'
        > & {
...
export type DeleteResourceMutation = { __typename?: 'Mutation' } & {
    deleteResource: Maybe<
        { __typename?: 'DeleteResourceMutationPayload' } & Pick<DeleteResourceMutationPayload, 'message'> & {
                errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
            }
    >;
};
...
export type SchoolDetailQuery = { __typename?: 'Query' } & {
    school: Maybe<
        { __typename?: 'SchoolObjectType' } & Pick<
            SchoolObjectType,
            'id' | 'name' | 'city' | 'country' | 'schoolType' | 'subjectCount' | 'courseCount'
        > & {
                subjects: Maybe<
                    Array<Maybe<{ __typename?: 'SubjectObjectType' } & Pick<SubjectObjectType, 'id' | 'name'>>>
                >;
                courses: Array<
                    { __typename?: 'CourseObjectType' } & Pick<CourseObjectType, 'id' | 'name' | 'code' | 'points'>
                >;
            }
    >;
};
...
export type SearchCoursesQuery = { __typename?: 'Query' } & {
    courses: Maybe<Array<Maybe<{ __typename?: 'CourseObjectType' } & Pick<CourseObjectType, 'id' | 'name' | 'code'>>>>;
    school: Maybe<{ __typename?: 'SchoolObjectType' } & Pick<SchoolObjectType, 'id' | 'name'>>;
    subject: Maybe<{ __typename?: 'SubjectObjectType' } & Pick<SubjectObjectType, 'id' | 'name'>>;
    schoolType: Maybe<{ __typename?: 'SchoolTypeObjectType' } & Pick<SchoolTypeObjectType, 'id' | 'name'>>;
    country: Maybe<{ __typename?: 'CountryObjectType' } & Pick<CountryObjectType, 'id' | 'name'>>;
    city: Maybe<{ __typename?: 'CityObjectType' } & Pick<CityObjectType, 'id' | 'name'>>;
};
    ...
    users: Maybe<
        Array<
            Maybe<
                { __typename?: 'UserObjectType' } & Pick<
                    UserObjectType,
                    'id' | 'username' | 'points' | 'avatarThumbnail'
                >
            >
        >
    >;
    ...
    updateUser: Maybe<
        { __typename?: 'UpdateUserMutationPayload' } & {
            user: Maybe<
                { __typename?: 'UserObjectType' } & Pick<
                    UserObjectType,
                    'id' | 'username' | 'email' | 'title' | 'bio' | 'avatar' | 'points' | 'created'
                >
            >;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
...
export type PerformVoteMutation = { __typename?: 'Mutation' } & {
    performVote: Maybe<
        { __typename?: 'VoteMutationPayload' } & Pick<VoteMutationPayload, 'targetPoints'> & {
                vote: Maybe<{ __typename?: 'VoteObjectType' } & Pick<VoteObjectType, 'id' | 'status'>>;
                errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
            }
    >;
...
export function useUserMeLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<UserMeQuery, UserMeQueryVariables>,
) {
...
export function useDeleteAccountMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteAccountMutation, DeleteAccountMutationVariables>,
) {
...
export function useSchoolTypesQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<SchoolTypesQuery, SchoolTypesQueryVariables>,
) {
    return ApolloReactHooks.useQuery<SchoolTypesQuery, SchoolTypesQueryVariables>(SchoolTypesDocument, baseOptions);
}
export function useSchoolTypesLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SchoolTypesQuery, SchoolTypesQueryVariables>,
) {
...
export function useCoursesLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CoursesQuery, CoursesQueryVariables>,
) {
...
export function useSubjectsQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<SubjectsQuery, SubjectsQueryVariables>,
) {
...
export function useSubjectsLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SubjectsQuery, SubjectsQueryVariables>,
) {
...
export function useResourceTypesQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<ResourceTypesQuery, ResourceTypesQueryVariables>,
) {
    return ApolloReactHooks.useQuery<ResourceTypesQuery, ResourceTypesQueryVariables>(
        ResourceTypesDocument,
        baseOptions,
    );
}
export function useResourceTypesLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ResourceTypesQuery, ResourceTypesQueryVariables>,
) {
    return ApolloReactHooks.useLazyQuery<ResourceTypesQuery, ResourceTypesQueryVariables>(
        ResourceTypesDocument,
        baseOptions,
    );
}
...
export function useContactMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<ContactMutation, ContactMutationVariables>,
) {
...
export function useCourseDetailQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<CourseDetailQuery, CourseDetailQueryVariables>,
) {
...
export function useCourseDetailLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CourseDetailQuery, CourseDetailQueryVariables>,
) {
    return ApolloReactHooks.useLazyQuery<CourseDetailQuery, CourseDetailQueryVariables>(
...
export function useCreateCourseMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<CreateCourseMutation, CreateCourseMutationVariables>,
) {
    return ApolloReactHooks.useMutation<CreateCourseMutation, CreateCourseMutationVariables>(
...
export function useCreateResourceInitialDataQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<
        CreateResourceInitialDataQuery,
        CreateResourceInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useQuery<CreateResourceInitialDataQuery, CreateResourceInitialDataQueryVariables>(
        CreateResourceInitialDataDocument,
        baseOptions,
    );
}
export function useCreateResourceInitialDataLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        CreateResourceInitialDataQuery,
        CreateResourceInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useLazyQuery<CreateResourceInitialDataQuery, CreateResourceInitialDataQueryVariables>(
        CreateResourceInitialDataDocument,
        baseOptions,
    );
}
...
export type CreateResourceInitialDataQueryResult = ApolloReactCommon.QueryResult<
    CreateResourceInitialDataQuery,
    CreateResourceInitialDataQueryVariables
>;
...
`;
export type CreateResourceMutationFn = ApolloReactCommon.MutationFunction<
    CreateResourceMutation,
    CreateResourceMutationVariables
>;

export function useCreateResourceMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<CreateResourceMutation, CreateResourceMutationVariables>,
) {
    return ApolloReactHooks.useMutation<CreateResourceMutation, CreateResourceMutationVariables>(
...
export type CreateResourceMutationOptions = ApolloReactCommon.BaseMutationOptions<
    CreateResourceMutation,
    CreateResourceMutationVariables
>;
...
export function useResourceDetailQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<ResourceDetailQuery, ResourceDetailQueryVariables>,
) {
    return ApolloReactHooks.useQuery<ResourceDetailQuery, ResourceDetailQueryVariables>(
        ResourceDetailDocument,
        baseOptions,
    );
}
export function useResourceDetailLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<ResourceDetailQuery, ResourceDetailQueryVariables>,
) {
    return ApolloReactHooks.useLazyQuery<ResourceDetailQuery, ResourceDetailQueryVariables>(
        ResourceDetailDocument,
        baseOptions,
    );
}
...
export type ResourceDetailQueryResult = ApolloReactCommon.QueryResult<
    ResourceDetailQuery,
...
`;
export type DeleteResourceMutationFn = ApolloReactCommon.MutationFunction<
    DeleteResourceMutation,
    DeleteResourceMutationVariables
>;

export function useDeleteResourceMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<DeleteResourceMutation, DeleteResourceMutationVariables>,
) {
    return ApolloReactHooks.useMutation<DeleteResourceMutation, DeleteResourceMutationVariables>(
...
export type DeleteResourceMutationOptions = ApolloReactCommon.BaseMutationOptions<
    DeleteResourceMutation,
    DeleteResourceMutationVariables
>;
...
export function useSchoolDetailQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<SchoolDetailQuery, SchoolDetailQueryVariables>,
) {
    return ApolloReactHooks.useQuery<SchoolDetailQuery, SchoolDetailQueryVariables>(SchoolDetailDocument, baseOptions);
}
export function useSchoolDetailLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SchoolDetailQuery, SchoolDetailQueryVariables>,
) {
    return ApolloReactHooks.useLazyQuery<SchoolDetailQuery, SchoolDetailQueryVariables>(
...
export function useSearchCoursesQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<SearchCoursesQuery, SearchCoursesQueryVariables>,
) {
    return ApolloReactHooks.useQuery<SearchCoursesQuery, SearchCoursesQueryVariables>(
        SearchCoursesDocument,
        baseOptions,
    );
}
export function useSearchCoursesLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SearchCoursesQuery, SearchCoursesQueryVariables>,
) {
    return ApolloReactHooks.useLazyQuery<SearchCoursesQuery, SearchCoursesQueryVariables>(
        SearchCoursesDocument,
        baseOptions,
    );
}
...
export function useUserDetailQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<UserDetailQuery, UserDetailQueryVariables>,
) {
...
export function useUserDetailLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<UserDetailQuery, UserDetailQueryVariables>,
) {
...
`;
export type PerformVoteMutationFn = ApolloReactCommon.MutationFunction<
    PerformVoteMutation,
    PerformVoteMutationVariables
>;

export function usePerformVoteMutation(
    baseOptions?: ApolloReactHooks.MutationHookOptions<PerformVoteMutation, PerformVoteMutationVariables>,
) {
    return ApolloReactHooks.useMutation<PerformVoteMutation, PerformVoteMutationVariables>(
        PerformVoteDocument,
        baseOptions,
    );
}
...
export type PerformVoteMutationOptions = ApolloReactCommon.BaseMutationOptions<
    PerformVoteMutation,
    PerformVoteMutationVariables
>;
