...
export type SignUpMutation = { __typename?: 'Mutation' } & {
    signUp: Maybe<
        { __typename?: 'SignUpMutationPayload' } & {
            user: Maybe<{ __typename?: 'UserType' } & Pick<UserType, 'id' | 'created'>>;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
    >;
    signIn: Maybe<
        { __typename?: 'SignInMutationPayload' } & Pick<SignInMutationPayload, 'token'> & {
                user: Maybe<
...
export type CreateCourseMutation = { __typename?: 'Mutation' } & {
    createCourse: Maybe<
        { __typename?: 'CreateCourseMutationPayload' } & {
            course: Maybe<{ __typename?: 'CourseType' } & Pick<CourseType, 'id'>>;
            errors: Maybe<Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>>;
        }
    >;
};
...
export type UsersQuery = { __typename?: 'Query' } & {
    users: Maybe<
        Array<Maybe<{ __typename?: 'UserType' } & Pick<UserType, 'id' | 'username' | 'points' | 'avatarThumbnail'>>>
    >;
};
...
export type SearchQuery = { __typename?: 'Query' } & {
    courses: Maybe<Array<Maybe<{ __typename?: 'CourseType' } & Pick<CourseType, 'id' | 'name' | 'code'>>>>;
    schools: Maybe<Array<Maybe<{ __typename?: 'SchoolType' } & Pick<SchoolType, 'id' | 'name'>>>>;
    subjects: Maybe<Array<Maybe<{ __typename?: 'SubjectType' } & Pick<SubjectType, 'id' | 'name'>>>>;
    schoolTypes: Maybe<
        Array<Maybe<{ __typename?: 'SchoolTypeObjectType' } & Pick<SchoolTypeObjectType, 'id' | 'name'>>>
    >;
    countries: Maybe<Array<Maybe<{ __typename?: 'CountryType' } & Pick<CountryType, 'id' | 'name'>>>>;
    cities: Maybe<Array<Maybe<{ __typename?: 'CityType' } & Pick<CityType, 'id' | 'name'>>>>;
};
...
export type CourseDetailQuery = { __typename?: 'Query' } & {
    course: Maybe<
        { __typename?: 'CourseType' } & Pick<
            CourseType,
            'id' | 'name' | 'code' | 'modified' | 'created' | 'points' | 'resourceCount'
        > & {
                subject: { __typename?: 'SubjectType' } & Pick<SubjectType, 'id' | 'name'>;
                school: { __typename?: 'SchoolType' } & Pick<SchoolType, 'id' | 'name'>;
                creator: Maybe<{ __typename?: 'UserType' } & Pick<UserType, 'id' | 'username'>>;
                resources: Array<{ __typename?: 'ResourceType' } & Pick<ResourceType, 'id' | 'title' | 'points'>>;
            }
    >;
};
...
export type ResourceDetailQuery = { __typename?: 'Query' } & {
    resource: Maybe<
        { __typename?: 'ResourceType' } & Pick<
            ResourceType,
            'id' | 'resourceType' | 'title' | 'file' | 'date' | 'created' | 'modified' | 'points'
        > & {
                creator: Maybe<{ __typename?: 'UserType' } & Pick<UserType, 'id'>>;
                resourceParts: Array<
                    { __typename?: 'ResourcePartType' } & Pick<ResourcePartType, 'id' | 'title' | 'file' | 'text'>
                >;
            }
    >;
};
...
export type UploadResourceInitialDataQuery = { __typename?: 'Query' } & {
    resourceTypes: Maybe<
        Array<
            Maybe<{ __typename?: 'ResourceTypeObjectType' } & Pick<ResourceTypeObjectType, 'id' | 'name' | 'hasParts'>>
        >
    >;
    courses: Maybe<Array<Maybe<{ __typename?: 'CourseType' } & Pick<CourseType, 'id' | 'name'>>>>;
};

export type CreateCourseInitialDataQueryVariables = {};

export type CreateCourseInitialDataQuery = { __typename?: 'Query' } & {
    subjects: Maybe<Array<Maybe<{ __typename?: 'SubjectType' } & Pick<SubjectType, 'id' | 'name'>>>>;
    schools: Maybe<Array<Maybe<{ __typename?: 'SchoolType' } & Pick<SchoolType, 'id' | 'name'>>>>;
};
...
export function useUploadResourceInitialDataQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<
        UploadResourceInitialDataQuery,
        UploadResourceInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useQuery<UploadResourceInitialDataQuery, UploadResourceInitialDataQueryVariables>(
        UploadResourceInitialDataDocument,
        baseOptions,
    );
}
export function useUploadResourceInitialDataLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        UploadResourceInitialDataQuery,
        UploadResourceInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useLazyQuery<UploadResourceInitialDataQuery, UploadResourceInitialDataQueryVariables>(
        UploadResourceInitialDataDocument,
        baseOptions,
    );
}
...
export type UploadResourceInitialDataQueryResult = ApolloReactCommon.QueryResult<
    UploadResourceInitialDataQuery,
    UploadResourceInitialDataQueryVariables
>;
...
export function useCreateCourseInitialDataQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<
        CreateCourseInitialDataQuery,
        CreateCourseInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useQuery<CreateCourseInitialDataQuery, CreateCourseInitialDataQueryVariables>(
        CreateCourseInitialDataDocument,
        baseOptions,
    );
}
export function useCreateCourseInitialDataLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
        CreateCourseInitialDataQuery,
        CreateCourseInitialDataQueryVariables
    >,
) {
    return ApolloReactHooks.useLazyQuery<CreateCourseInitialDataQuery, CreateCourseInitialDataQueryVariables>(
        CreateCourseInitialDataDocument,
        baseOptions,
    );
}
...
export type CreateCourseInitialDataQueryResult = ApolloReactCommon.QueryResult<
    CreateCourseInitialDataQuery,
    CreateCourseInitialDataQueryVariables
>;
