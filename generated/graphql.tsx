...
export type ChangePasswordMutation = { __typename?: 'Mutation' } & {
  changePassword: Maybe<
    { __typename?: 'ChangePasswordMutationPayload' } & {
      user: Maybe<
        { __typename?: 'UserTypeChangePassword' } & Pick<UserTypeChangePassword, 'id' | 'modified'>
      >;
      errors: Maybe<
        Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>
      >;
    }
  >;
};
...
export type RegisterMutation = { __typename?: 'Mutation' } & {
  register: Maybe<
    { __typename?: 'RegisterMutationPayload' } & {
      user: Maybe<{ __typename?: 'UserTypeRegister' } & Pick<UserTypeRegister, 'id' | 'created'>>;
      errors: Maybe<
        Array<Maybe<{ __typename?: 'ErrorType' } & Pick<ErrorType, 'field' | 'messages'>>>
      >;
    }
  >;
  login: Maybe<
    { __typename?: 'LoginMutation' } & Pick<LoginMutation, 'token'> & {
        user: Maybe<
          { __typename?: 'UserTypePrivate' } & Pick<
            UserTypePrivate,
            'id' | 'title' | 'bio' | 'points' | 'created' | 'email' | 'language'
          >
        >;
      }
  >;
...
export type SchoolQuery = { __typename?: 'Query' } & {
  school: Maybe<{ __typename?: 'SchoolType' } & Pick<SchoolType, 'name'>>;
};

export type SchoolListQueryVariables = {};

export type SchoolListQuery = { __typename?: 'Query' } & {
  schoolList: Maybe<Array<Maybe<{ __typename?: 'SchoolType' } & Pick<SchoolType, 'name'>>>>;
};
...
export type UserQuery = { __typename?: 'Query' } & {
  user: Maybe<
    { __typename?: 'UserTypePublic' } & Pick<
      UserTypePublic,
      'id' | 'username' | 'title' | 'bio' | 'points' | 'created'
    >
  >;
};
...
export type UserListQuery = { __typename?: 'Query' } & {
  userList: Maybe<
    Array<
      Maybe<{ __typename?: 'UserTypePublic' } & Pick<UserTypePublic, 'id' | 'username' | 'points'>>
    >
  >;
};
...
export type UserMeQuery = { __typename?: 'Query' } & {
  userMe: Maybe<
    { __typename?: 'UserTypePrivate' } & Pick<
      UserTypePrivate,
      'id' | 'username' | 'email' | 'title' | 'bio' | 'points' | 'language'
    >
  >;
};
...
export function useSchoolQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<SchoolQuery, SchoolQueryVariables>
) {
  return ApolloReactHooks.useQuery<SchoolQuery, SchoolQueryVariables>(SchoolDocument, baseOptions);
}
export function useSchoolLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SchoolQuery, SchoolQueryVariables>
) {
  return ApolloReactHooks.useLazyQuery<SchoolQuery, SchoolQueryVariables>(
    SchoolDocument,
    baseOptions
  );
}
...
export function useSchoolListQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<SchoolListQuery, SchoolListQueryVariables>
) {
  return ApolloReactHooks.useQuery<SchoolListQuery, SchoolListQueryVariables>(
    SchoolListDocument,
    baseOptions
  );
}
export function useSchoolListLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SchoolListQuery, SchoolListQueryVariables>
) {
  return ApolloReactHooks.useLazyQuery<SchoolListQuery, SchoolListQueryVariables>(
    SchoolListDocument,
    baseOptions
  );
}
...
export type SchoolListQueryResult = ApolloReactCommon.QueryResult<
  SchoolListQuery,
...
export function useUserMeQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<UserMeQuery, UserMeQueryVariables>
) {
...
export function useUserMeLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<UserMeQuery, UserMeQueryVariables>(
    UserMeDocument,
    baseOptions
  );
}
