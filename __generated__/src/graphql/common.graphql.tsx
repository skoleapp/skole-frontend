/* a347b9255b9e283da6c6ad611568f83de78ede47
...
export type Query = {
  ...
  trendingComments?: Maybe<Array<Maybe<CommentObjectType>>>;
  /**
...
export type UserMeFieldsFragment = (
  { __typename?: 'UserObjectType' }
  & Pick<UserObjectType, 'id' | 'slug' | 'username' | 'email' | 'title' | 'bio' | 'avatar' | 'avatarThumbnail' | 'score' | 'created' | 'verified' | 'unreadActivityCount' | 'fcmToken' | 'rank' | 'commentReplyEmailPermission' | 'courseCommentEmailPermission' | 'resourceCommentEmailPermission' | 'commentReplyPushPermission' | 'courseCommentPushPermission' | 'resourceCommentPushPermission'>
  & { school?: Maybe<(
    { __typename?: 'SchoolObjectType' }
    & Pick<SchoolObjectType, 'id' | 'slug' | 'name'>
  )>, subject?: Maybe<(
...
export type TrendingCommentsQueryVariables = Exact<{ [key: string]: never; }>;


export type TrendingCommentsQuery = (
  { __typename?: 'Query' }
  & { trendingComments?: Maybe<Array<Maybe<(
    { __typename?: 'CommentObjectType' }
    & CommentFieldsFragment
  )>>> }
);
...
export const UpdateAccountSettingsDocument = gql`
    mutation UpdateAccountSettings($email: String!, $school: ID, $subject: ID, $commentReplyEmailPermission: Boolean, $courseCommentEmailPermission: Boolean, $resourceCommentEmailPermission: Boolean, $commentReplyPushPermission: Boolean, $courseCommentPushPermission: Boolean, $resourceCommentPushPermission: Boolean) {
  updateAccountSettings(
    input: {email: $email, school: $school, subject: $subject, commentReplyEmailPermission: $commentReplyEmailPermission, courseCommentEmailPermission: $courseCommentEmailPermission, resourceCommentEmailPermission: $resourceCommentEmailPermission, commentReplyPushPermission: $commentReplyPushPermission, courseCommentPushPermission: $courseCommentPushPermission, resourceCommentPushPermission: $resourceCommentPushPermission}
  ) {
    successMessage
    user {
      ...userMeFields
...
export const TrendingCommentsDocument = gql`
...
/**
 * __useTrendingCommentsQuery__
 *
 * To run a query within a React component, call `useTrendingCommentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useTrendingCommentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 ...
 * });
 */
export function useTrendingCommentsQuery(baseOptions?: Apollo.QueryHookOptions<TrendingCommentsQuery, TrendingCommentsQueryVariables>) {
        return Apollo.useQuery<TrendingCommentsQuery, TrendingCommentsQueryVariables>(TrendingCommentsDocument, baseOptions);
      }
export function useTrendingCommentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TrendingCommentsQuery, TrendingCommentsQueryVariables>) {
          return Apollo.useLazyQuery<TrendingCommentsQuery, TrendingCommentsQueryVariables>(TrendingCommentsDocument, baseOptions);
        }
export type TrendingCommentsQueryHookResult = ReturnType<typeof useTrendingCommentsQuery>;
export type TrendingCommentsLazyQueryHookResult = ReturnType<typeof useTrendingCommentsLazyQuery>;
export type TrendingCommentsQueryResult = Apollo.QueryResult<TrendingCommentsQuery, TrendingCommentsQueryVariables>;
