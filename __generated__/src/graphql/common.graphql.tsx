/* 4315e0908626c3345d1606cc6451b3ed6905dcdc
...
export type Query = {
   ...
   * Only allowed for authenticated users.
   */
  suggestedCourses?: Maybe<Array<Maybe<CourseObjectType>>>;
  /**
   * Return preview of suggested courses based on secret Skole AI-powered algorithms.
   * 
   * Only allowed for authenticated users.
   */
  suggestedCoursesPreview?: Maybe<Array<Maybe<CourseObjectType>>>;
  /** Return a single object based on the ID. If an object is not found or it has been soft deleted, return `null` instead. */
...
export type CourseQuery = (
  ...
  & { course?: Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'id' | 'name' | 'code' | 'modified' | 'created' | 'score' | 'starred' | 'starCount'>
    & { vote?: Maybe<(
      { __typename?: 'VoteObjectType' }
      & Pick<VoteObjectType, 'id' | 'status'>
    )>, subjects: Array<(
...
export type ResourceQuery = (
  ...
  & { resource?: Maybe<(
    { __typename?: 'ResourceObjectType' }
    & Pick<ResourceObjectType, 'id' | 'title' | 'file' | 'date' | 'modified' | 'created' | 'score' | 'starred' | 'starCount' | 'downloads'>
    & { resourceType?: Maybe<(
      { __typename?: 'ResourceTypeObjectType' }
...
export type SuggestionsQuery = (
  { __typename?: 'Query' }
  & { suggestedCourses?: Maybe<Array<Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'id' | 'name' | 'code' | 'score' | 'starCount' | 'resourceCount' | 'commentCount'>
    & { user?: Maybe<(
      { __typename?: 'UserObjectType' }
...
export type SuggestionsPreviewQuery = (
  { __typename?: 'Query' }
  & { suggestedCoursesPreview?: Maybe<Array<Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'id' | 'name' | 'code' | 'score' | 'starCount' | 'resourceCount' | 'commentCount'>
    & { user?: Maybe<(
      { __typename?: 'UserObjectType' }
...
export const CreateCommentDocument = gql`
    mutation CreateComment($user: String, $text: String!, $attachment: String, $course: ID, $resource: ID, $comment: ID) {
  createComment(
    input: {user: $user, text: $text, attachment: $attachment, course: $course, resource: $resource, comment: $comment}
  ) {
    successMessage
    comment {
      id
...
export const CoursesDocument = gql`
    query Courses($courseName: String, $courseCode: String, $school: ID, $subject: ID, $schoolType: ID, $country: ID, $city: ID, $ordering: String, $page: Int, $pageSize: Int) {
  courses(
