/* 886fcf1f78cb57821806263639e229bfa72a2df1
...
export type CourseQuery = (
  ...
  & { course?: Maybe<(
    ...
    & { vote?: Maybe<(
      ...
      { __typename?: 'CommentObjectType' }
      & Pick<CommentObjectType, 'id' | 'text' | 'attachment' | 'created' | 'score'>
      & { user?: Maybe<(
        { __typename?: 'UserObjectType' }
        & Pick<UserObjectType, 'id' | 'username' | 'avatarThumbnail'>
      )>, replyComments: Array<(
...
export type SuggestionsPreviewQuery = (
  ...
  & { suggestionsPreview?: Maybe<Array<Maybe<(
    ...
    { __typename?: 'ResourceObjectType' }
    & Pick<ResourceObjectType, 'id' | 'title' | 'score' | 'starCount' | 'commentCount' | 'downloads'>
    & { resourceType?: Maybe<(
      { __typename?: 'ResourceTypeObjectType' }
      & Pick<ResourceTypeObjectType, 'name'>
    )>, course: (
