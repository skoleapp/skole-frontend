/* e0f26f2586082c088e254a7003164d45048a95d9
...
export type InviteCodeObjectType = {
...
export type MutationUseInviteCodeArgs = {
...
export type UseInviteCodeMutationInput = {
  usernameOrEmail: Scalars['String'];
  code: Scalars['String'];
  clientMutationId?: Maybe<Scalars['String']>;
};
 ...
 * After successfully entering the invite code, send account verification email.
 */
export type UseInviteCodeMutationPayload = {
...
export type UseInviteCodeAndLoginMutationVariables = Exact<{
  code: Scalars['String'];
  usernameOrEmail: Scalars['String'];
  password: Scalars['String'];
}>;
...
export type UseInviteCodeAndLoginMutation = (
  { __typename?: 'Mutation' }
  & { useInviteCode?: Maybe<(
    { __typename?: 'UseInviteCodeMutationPayload' }
    & { errors?: Maybe<Array<Maybe<(
...
export const UseInviteCodeAndLoginDocument = gql`
    mutation UseInviteCodeAndLogin($code: String!, $usernameOrEmail: String!, $password: String!) {
  useInviteCode(input: {code: $code, usernameOrEmail: $usernameOrEmail}) {
    errors {
      field
      messages
    }
  ...
  login(input: {usernameOrEmail: $usernameOrEmail, password: $password}) {
    ...
    ${UserFieldsFragmentDoc}`;
export type UseInviteCodeAndLoginMutationFn = Apollo.MutationFunction<UseInviteCodeAndLoginMutation, UseInviteCodeAndLoginMutationVariables>;
 ...
 * });
 */
export function useUseInviteCodeAndLoginMutation(baseOptions?: Apollo.MutationHookOptions<UseInviteCodeAndLoginMutation, UseInviteCodeAndLoginMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UseInviteCodeAndLoginMutation, UseInviteCodeAndLoginMutationVariables>(UseInviteCodeAndLoginDocument, options);
      }
export type UseInviteCodeAndLoginMutationHookResult = ReturnType<typeof useUseInviteCodeAndLoginMutation>;
export type UseInviteCodeAndLoginMutationResult = Apollo.MutationResult<UseInviteCodeAndLoginMutation>;
export type UseInviteCodeAndLoginMutationOptions = Apollo.BaseMutationOptions<UseInviteCodeAndLoginMutation, UseInviteCodeAndLoginMutationVariables>;