/* 36d03f366a5c853793b46e84848814e63e45bc02
...
/**
 * Models the progress of an single badge.
 *
...
export type UserMeFieldsFragment = (
  { __typename?: 'UserObjectType' }
  & Pick<UserObjectType, 'id' | 'slug' | 'username' | 'email' | 'title' | 'bio' | 'avatar' | 'avatarThumbnail' | 'score' | 'created' | 'verified' | 'unreadActivityCount' | 'rank' | 'productUpdateEmailPermission' | 'blogPostEmailPermission' | 'commentReplyEmailPermission' | 'courseCommentEmailPermission' | 'resourceCommentEmailPermission'>
  & { school?: Maybe<(
    { __typename?: 'SchoolObjectType' }
    & Pick<SchoolObjectType, 'id' | 'slug' | 'name'>
  )>, subject?: Maybe<(
...
export const UpdateAccountSettingsDocument = gql`
    mutation UpdateAccountSettings($email: String!, $school: ID, $subject: ID, $productUpdateEmailPermission: Boolean, $blogPostEmailPermission: Boolean, $commentReplyEmailPermission: Boolean, $courseCommentEmailPermission: Boolean, $resourceCommentEmailPermission: Boolean) {
