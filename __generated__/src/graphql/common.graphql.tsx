/* 367fbc9c35e7ff876cb86e4fe65c21881a5969c4
...
export type Query = {
  ...
  emailSubscription?: Maybe<EmailSubscriptionObjectType>;
  /**
...
export type QueryEmailSubscriptionArgs = {
...
export type UserObjectType = {
  ...
  courseCommentEmailPermission?: Maybe<Scalars['Boolean']>;
  resourceCommentEmailPermission?: Maybe<Scalars['Boolean']>;
  commentReplyPushPermission?: Maybe<Scalars['Boolean']>;
  courseCommentPushPermission?: Maybe<Scalars['Boolean']>;
  resourceCommentPushPermission?: Maybe<Scalars['Boolean']>;
...
export type EmailSubscriptionObjectType = {
  __typename?: 'EmailSubscriptionObjectType';
  email: Scalars['String'];
  productUpdates: Scalars['Boolean'];
...
export type Mutation = {
  ...
  createEmailSubscription?: Maybe<CreateEmailSubscriptionMutationPayload>;
  /** Modify or delete and existing email subscription. */
  updateEmailSubscription?: Maybe<UpdateEmailSubscriptionMutationPayload>;
  /**
   * Create a new course.
   *
   * Only allowed for authenticated users that have verified their accounts.
...
/** Subscribe to marketing emails. */
export type CreateEmailSubscriptionMutationPayload = {
  __typename?: 'CreateEmailSubscriptionMutationPayload';
  email: Scalars['String'];
  errors?: Maybe<Array<Maybe<ErrorType>>>;
  successMessage?: Maybe<Scalars['String']>;
  clientMutationId?: Maybe<Scalars['String']>;
...
export type CreateEmailSubscriptionMutationInput = {
  email: Scalars['String'];
  clientMutationId?: Maybe<Scalars['String']>;
};

/** Modify or delete and existing email subscription. */
export type UpdateEmailSubscriptionMutationPayload = {
  __typename?: 'UpdateEmailSubscriptionMutationPayload';
  emailSubscription?: Maybe<EmailSubscriptionObjectType>;
  errors?: Maybe<Array<Maybe<ErrorType>>>;
  successMessage?: Maybe<Scalars['String']>;
  clientMutationId?: Maybe<Scalars['String']>;
...
export type UpdateEmailSubscriptionMutationInput = {
  productUpdates?: Maybe<Scalars['Boolean']>;
  blogPosts?: Maybe<Scalars['Boolean']>;
  token?: Maybe<Scalars['String']>;
  clientMutationId?: Maybe<Scalars['String']>;
};
...
export type ActivityFieldsFragment = (
  ...
  & { causingUser?: Maybe<(
    ...
    & { user: (
      { __typename?: 'UserObjectType' }
      & Pick<UserObjectType, 'slug'>
    ), badge: (
      { __typename?: 'BadgeObjectType' }
      & Pick<BadgeObjectType, 'name'>
    ) }
  )> }
);
...
export type CourseSeoPropsQuery = (
  ...
  & { course?: Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'name' | 'codes'>
  )> }
);
...
export type UserMeFieldsFragment = (
  { __typename?: 'UserObjectType' }
  & Pick<UserObjectType, 'id' | 'slug' | 'username' | 'email' | 'title' | 'bio' | 'avatar' | 'avatarThumbnail' | 'score' | 'created' | 'verified' | 'unreadActivityCount' | 'fcmToken' | 'rank' | 'productUpdateEmailPermission' | 'blogPostEmailPermission' | 'commentReplyEmailPermission' | 'courseCommentEmailPermission' | 'resourceCommentEmailPermission' | 'commentReplyPushPermission' | 'courseCommentPushPermission' | 'resourceCommentPushPermission'>
  & { school?: Maybe<(
    { __typename?: 'SchoolObjectType' }
    & Pick<SchoolObjectType, 'id' | 'slug' | 'name'>
  )>, subject?: Maybe<(
...
export type CommentFieldsFragment = (
  { __typename?: 'CommentObjectType' }
  & Pick<CommentObjectType, 'id' | 'text' | 'attachment' | 'attachmentThumbnail' | 'created' | 'score' | 'replyCount'>
  & { user?: Maybe<(
    { __typename?: 'UserObjectType' }
...
export type CreateEmailSubscriptionMutation = (
  ...
  & { createEmailSubscription?: Maybe<(
    { __typename?: 'CreateEmailSubscriptionMutationPayload' }
    & Pick<CreateEmailSubscriptionMutationPayload, 'successMessage'>
    & { errors?: Maybe<Array<Maybe<(
      { __typename?: 'ErrorType' }
      & Pick<ErrorType, 'field' | 'messages'>
    )>>> }
...
export type EmailSubscriptionQueryVariables = Exact<{
  token: Scalars['String'];
}>;


export type EmailSubscriptionQuery = (
  { __typename?: 'Query' }
  & { emailSubscription?: Maybe<(
    { __typename?: 'EmailSubscriptionObjectType' }
    & Pick<EmailSubscriptionObjectType, 'email' | 'productUpdates' | 'blogPosts'>
  )> }
);
...
export type UpdateEmailSubscriptionMutation = (
  { __typename?: 'Mutation' }
  & { updateEmailSubscription?: Maybe<(
    { __typename?: 'UpdateEmailSubscriptionMutationPayload' }
    & Pick<UpdateEmailSubscriptionMutationPayload, 'successMessage'>
    & { errors?: Maybe<Array<Maybe<(
      { __typename?: 'ErrorType' }
      & Pick<ErrorType, 'field' | 'messages'>
    )>>>, emailSubscription?: Maybe<(
...
export const CreateCommentDocument = gql`
    mutation CreateComment($user: ID, $text: String!, $attachment: String, $course: ID, $resource: ID, $comment: ID, $school: ID) {
  createComment(
...
export const UpdateAccountSettingsDocument = gql`
    mutation UpdateAccountSettings($email: String!, $school: ID, $subject: ID, $productUpdateEmailPermission: Boolean, $blogPostEmailPermission: Boolean, $commentReplyEmailPermission: Boolean, $courseCommentEmailPermission: Boolean, $resourceCommentEmailPermission: Boolean, $commentReplyPushPermission: Boolean, $courseCommentPushPermission: Boolean, $resourceCommentPushPermission: Boolean) {
  updateAccountSettings(
    input: {email: $email, school: $school, subject: $subject, productUpdateEmailPermission: $productUpdateEmailPermission, blogPostEmailPermission: $blogPostEmailPermission, commentReplyEmailPermission: $commentReplyEmailPermission, courseCommentEmailPermission: $courseCommentEmailPermission, resourceCommentEmailPermission: $resourceCommentEmailPermission, commentReplyPushPermission: $commentReplyPushPermission, courseCommentPushPermission: $courseCommentPushPermission, resourceCommentPushPermission: $resourceCommentPushPermission}
  ) {
    successMessage
    user {
      ...userMeFields
 ...
 *      courseCommentEmailPermission: // value for 'courseCommentEmailPermission'
 *      resourceCommentEmailPermission: // value for 'resourceCommentEmailPermission'
 *      commentReplyPushPermission: // value for 'commentReplyPushPermission'
 *      courseCommentPushPermission: // value for 'courseCommentPushPermission'
 *      resourceCommentPushPermission: // value for 'resourceCommentPushPermission'
 *   },
 * });
 */
...
export const CreateEmailSubscriptionDocument = gql`
  ...
  createEmailSubscription(input: {email: $email}) {
    ...
    `;
export type CreateEmailSubscriptionMutationFn = Apollo.MutationFunction<CreateEmailSubscriptionMutation, CreateEmailSubscriptionMutationVariables>;
 ...
 * });
 */
export function useCreateEmailSubscriptionMutation(baseOptions?: Apollo.MutationHookOptions<CreateEmailSubscriptionMutation, CreateEmailSubscriptionMutationVariables>) {
        return Apollo.useMutation<CreateEmailSubscriptionMutation, CreateEmailSubscriptionMutationVariables>(CreateEmailSubscriptionDocument, baseOptions);
      }
export type CreateEmailSubscriptionMutationHookResult = ReturnType<typeof useCreateEmailSubscriptionMutation>;
export type CreateEmailSubscriptionMutationResult = Apollo.MutationResult<CreateEmailSubscriptionMutation>;
export type CreateEmailSubscriptionMutationOptions = Apollo.BaseMutationOptions<CreateEmailSubscriptionMutation, CreateEmailSubscriptionMutationVariables>;
export const EmailSubscriptionDocument = gql`
...
/**
 * __useEmailSubscriptionQuery__
 *
 * To run a query within a React component, call `useEmailSubscriptionQuery` and pass it any options that fit your needs.
 * When your component renders, `useEmailSubscriptionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEmailSubscriptionQuery({
 *   variables: {
 *      token: // value for 'token'
 *   },
 * });
 */
export function useEmailSubscriptionQuery(baseOptions: Apollo.QueryHookOptions<EmailSubscriptionQuery, EmailSubscriptionQueryVariables>) {
        return Apollo.useQuery<EmailSubscriptionQuery, EmailSubscriptionQueryVariables>(EmailSubscriptionDocument, baseOptions);
      }
export function useEmailSubscriptionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EmailSubscriptionQuery, EmailSubscriptionQueryVariables>) {
          return Apollo.useLazyQuery<EmailSubscriptionQuery, EmailSubscriptionQueryVariables>(EmailSubscriptionDocument, baseOptions);
        }
export type EmailSubscriptionQueryHookResult = ReturnType<typeof useEmailSubscriptionQuery>;
export type EmailSubscriptionLazyQueryHookResult = ReturnType<typeof useEmailSubscriptionLazyQuery>;
export type EmailSubscriptionQueryResult = Apollo.QueryResult<EmailSubscriptionQuery, EmailSubscriptionQueryVariables>;
export const UpdateEmailSubscriptionDocument = gql`
  ...
  updateEmailSubscription(
    ...
    `;
export type UpdateEmailSubscriptionMutationFn = Apollo.MutationFunction<UpdateEmailSubscriptionMutation, UpdateEmailSubscriptionMutationVariables>;
 ...
 *      blogPosts: // value for 'blogPosts'
 *   },
 * });
 */
export function useUpdateEmailSubscriptionMutation(baseOptions?: Apollo.MutationHookOptions<UpdateEmailSubscriptionMutation, UpdateEmailSubscriptionMutationVariables>) {
        return Apollo.useMutation<UpdateEmailSubscriptionMutation, UpdateEmailSubscriptionMutationVariables>(UpdateEmailSubscriptionDocument, baseOptions);
      }
export type UpdateEmailSubscriptionMutationHookResult = ReturnType<typeof useUpdateEmailSubscriptionMutation>;
export type UpdateEmailSubscriptionMutationResult = Apollo.MutationResult<UpdateEmailSubscriptionMutation>;
export type UpdateEmailSubscriptionMutationOptions = Apollo.BaseMutationOptions<UpdateEmailSubscriptionMutation, UpdateEmailSubscriptionMutationVariables>;
