/* 688444f1ab8901b41868c5dce7312e169093c282
...
export type CourseFieldsFragment = (
  { __typename?: 'CourseObjectType' }
  & Pick<CourseObjectType, 'slug' | 'name' | 'code' | 'score' | 'starCount' | 'resourceCount' | 'commentCount' | 'created'>
  & { user?: Maybe<(
    { __typename?: 'UserObjectType' }
...
export type CourseQuery = (
  ...
  & { course?: Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'id' | 'slug' | 'name' | 'code' | 'modified' | 'created' | 'score' | 'starred' | 'starCount' | 'commentCount'>
    & { vote?: Maybe<(
      { __typename?: 'VoteObjectType' }
...
export type AutocompleteCoursesQuery = (
  ...
  & { autocompleteCourses?: Maybe<Array<Maybe<(
    { __typename?: 'CourseObjectType' }
    & Pick<CourseObjectType, 'id' | 'slug' | 'name' | 'code'>
  )>>> }
);
...
export type DiscussionSuggestionsQuery = (
  ...
  & { discussionSuggestions?: Maybe<Array<Maybe<(
    { __typename: 'CourseObjectType' }
    & Pick<CourseObjectType, 'slug' | 'code'>
