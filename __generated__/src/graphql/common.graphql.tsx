/* 0636e3e939a5af734252a158a451954ee4524732
...
export type UserMeFieldsFragment = (
  { __typename?: 'UserObjectType' }
  & Pick<UserObjectType, 'id' | 'slug' | 'username' | 'email' | 'backupEmail' | 'title' | 'bio' | 'avatar' | 'avatarThumbnail' | 'score' | 'created' | 'verified' | 'unreadActivityCount' | 'fcmToken' | 'rank' | 'commentReplyEmailPermission' | 'threadCommentEmailPermission' | 'newBadgeEmailPermission' | 'commentReplyPushPermission' | 'threadCommentPushPermission' | 'newBadgePushPermission'>
...
export type CommentFieldsFragment = (
  { __typename?: 'CommentObjectType' }
  & Pick<CommentObjectType, 'id' | 'text' | 'image' | 'imageThumbnail' | 'file' | 'created' | 'score' | 'replyCount' | 'isOwn'>
  & { user?: Maybe<(
    { __typename?: 'UserObjectType' }
