/* 4aec04758262dbf1f5d3df26e408a6f0577c119f
...
export type Query = {
   ...
   */
  autocompleteDiscussions?: Maybe<Array<Maybe<DiscussionsUnion>>>;
  /**
...
export type QueryAutocompleteDiscussionsArgs = {
...
export type AutocompleteDiscussionsQueryVariables = Exact<{
  searchTerm?: Maybe<Scalars['String']>;
}>;


export type AutocompleteDiscussionsQuery = (
  { __typename?: 'Query' }
  & { autocompleteDiscussions?: Maybe<Array<Maybe<(
    { __typename: 'CourseObjectType' }
...
export const AutocompleteDiscussionsDocument = gql`
    query AutocompleteDiscussions($searchTerm: String) {
  autocompleteDiscussions(searchTerm: $searchTerm) {
    ... on CourseObjectType {
      id
      courseName: name
      code
...
/**
 * __useAutocompleteDiscussionsQuery__
 *
 * To run a query within a React component, call `useAutocompleteDiscussionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useAutocompleteDiscussionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAutocompleteDiscussionsQuery({
 *   variables: {
 *      searchTerm: // value for 'searchTerm'
 *   },
 * });
 */
export function useAutocompleteDiscussionsQuery(baseOptions?: Apollo.QueryHookOptions<AutocompleteDiscussionsQuery, AutocompleteDiscussionsQueryVariables>) {
        return Apollo.useQuery<AutocompleteDiscussionsQuery, AutocompleteDiscussionsQueryVariables>(AutocompleteDiscussionsDocument, baseOptions);
      }
export function useAutocompleteDiscussionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<AutocompleteDiscussionsQuery, AutocompleteDiscussionsQueryVariables>) {
          return Apollo.useLazyQuery<AutocompleteDiscussionsQuery, AutocompleteDiscussionsQueryVariables>(AutocompleteDiscussionsDocument, baseOptions);
        }
export type AutocompleteDiscussionsQueryHookResult = ReturnType<typeof useAutocompleteDiscussionsQuery>;
export type AutocompleteDiscussionsLazyQueryHookResult = ReturnType<typeof useAutocompleteDiscussionsLazyQuery>;
export type AutocompleteDiscussionsQueryResult = Apollo.QueryResult<AutocompleteDiscussionsQuery, AutocompleteDiscussionsQueryVariables>;